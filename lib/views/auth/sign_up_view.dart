                ...
                GestureDetector(
                  onTap: () async {
                    await SignUpRemote.signUp({
                      'fullname': signupController.name_controller.text,
                      'email': signupController.email_controller.text,
                      'password1': signupController.password_controller.text,
                      'password2': signupController.password_controller.text,
                      'gender': 'M',
                      'city': signupController.locationController.text,
                      'phone_number': signupController.phone_controller.text,
                    });
